...
class SecurityProfileScreen extends StatelessWidget {
  ...
  final List<Map<String, dynamic>> contactInfo = [
    {
      'label': 'Email Address',
      'value': 'james.reyes@secureguard.ph',
